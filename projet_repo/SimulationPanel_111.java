...
/*
    ...
    public SimulationPanel(Feu trafficLight1, Feu trafficLight2) {
        ...
        increaseVehicleSpeedButton = new JButton("Araç Hızını Artır");
        addPedestrianButton = new JButton("Yaya Sayısını Artır");
        increaseRedLightDurationButton = new JButton("Kırmızı Işık Süresini Artır");
        ...
        increaseRedLightDurationButton.addActionListener(e -> {
            int newDelay = trafficLight1.getDelay() + 1000; // Kırmızı ışık süresini 1 saniye artır
            trafficLight1.setDelay(newDelay);
            System.out.println("Red light duration increased to: " + newDelay);
        });

        // Butonları eklemek için bir panel oluşturma
        ...
        // Buton panelini ana panele ekleme
